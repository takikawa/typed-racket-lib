...
[handle-evt? (asym-pred Univ B (-filter (make-Evt Univ) 0) -top)]
...
[channel-put-evt? (asym-pred Univ B (-filter (-mu x (make-Evt x)) 0) -top)]
...
[semaphore-peek-evt? (asym-pred Univ B (-filter (-mu x (make-Evt x)) 0) -top)]
;[call-with-semaphore ???]
